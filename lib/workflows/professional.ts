...
export const PROFESSIONAL_WORKFLOWS: Record<string, Workflow> = {
  'marketing-campaign-launch': MARKETING_CAMPAIGN_WORKFLOW,
  'product-launch-gtm': PRODUCT_LAUNCH_GTM_WORKFLOW,
  'digital-marketing-audit': DIGITAL_MARKETING_AUDIT_WORKFLOW,
  'project-initiation': PROJECT_INITIATION_WORKFLOW,
  'sprint-delivery': SPRINT_DELIVERY_WORKFLOW,
  'business-case-development': BUSINESS_CASE_WORKFLOW,
  'requirements-gathering': REQUIREMENTS_GATHERING_WORKFLOW,
